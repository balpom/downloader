...
use Balpom\Downloader\Factory\Psr18FactoriesInterface;
use \Exception;

class Psr18Downloader extends AbstractDownloader
{
    ...
    public function __construct(
            ...
            Psr18FactoriesInterface $factory)
    {
        $this->client = $client;
    ...
    protected function send(RequestInterface $request): DownloadInterface
    {
